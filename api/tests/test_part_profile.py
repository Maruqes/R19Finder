...
class DraftTests(unittest.TestCase):
    ...
    def test_revision_and_pending_proposals(self):
        ...
        self.assertEqual(page_data(self.client.get(saved.json['url']))['order']['part_profile']['facts'][0]['verification_status'], 'unverified')
    ...
    def test_profile_snapshots_manual_and_scheduled(self):
        ...
        self.assertTrue(any(s['part_profile'] == profile for s in page_data(self.client.get(response.json['url']))['searches']))
